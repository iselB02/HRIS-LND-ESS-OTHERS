<div class="main_opcr">
    <div id="main-view">
      ...
      <div class="opcr_table">
          <div id="top_menu">
              <button id="new_opcr">Add OPCR</button>
          </div>
          <table id="submission_table">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                          <button class="view"  wire:click="download({{$opcr->reference_num}})">
      ...
      <form wire:submit.prevent="submitForm" id="opcr_view" wire:ignore.self>
          <div id="title">
              <h1>OFFICE PERFORMANCE COMMITMENT FORM (OPCR) PERFORMANCE MEASURES</h1>
          </div>
          <div id="opcr_form">
                  ...
                  <table>
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <input wire:model="cert_by" type="text" name="certBy" id="certBy">
                              </td>
                              <td>
                                  <label for="cert_date">Certification Date</label>
                              </td>
                              <td>
                                  <input wire:model="cert_date" type="date" name="cert_date" id="cert_date">
                              </td>
                          </tr>
                          <tr>
                              <td>
                              ...
                              <td>
                                  <input wire:model="app_by" type="text" name="appBy" id="appBy">
                              </td>
                              <td>
